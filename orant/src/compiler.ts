...
/**
 * Orant Lang Compiler (TypeScript)
...
class OrantCompiler {
  ...
  public compile(inputFile: string, outputFile: string | null = null): CompilationResult {
  ...
  private getDefaultOutputFile(inputFile: string): string {
